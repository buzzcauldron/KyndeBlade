...
| Combat defensive-window tones | `KyndeBlade_Godot/scripts/combat/combat_window_tone.gd` (`CombatWindowTone.make_tone_hz`) | *(engine-generated sine bursts at runtime)* | *(n/a — project-authored PCM)* | No third-party sample; plays on **SFX** bus |
| Combat enemy-kill impact | `KyndeBlade_Godot/scripts/combat/combat_window_tone.gd` (`CombatWindowTone.make_enemy_kill_impact`) | *(engine-generated thump + decay + noise at runtime)* | *(n/a — project-authored PCM)* | No third-party sample; plays on **SFX** bus during victory slow-mo; see [`GODOT_AUDIO_DESIGN.md`](../KyndeBlade_Godot/docs/GODOT_AUDIO_DESIGN.md) |
...
| Hub **Wales basemap** (Natural Earth derivative) | `KyndeBlade_Godot/assets/world/basemap_wales.png` | [Natural Earth 10m Admin 1](https://www.naturalearthdata.com/downloads/10m-cultural-vectors/) (`ne_10m_admin_1_states_provinces`); UK admin-1 polygons whose `region` contains **Wales**, rasterized inside project bbox | **Public domain** — [Natural Earth terms](https://www.naturalearthdata.com/about/terms-of-use/); credit **Natural Earth** / **NACIS** in shipped credits if feasible | Pack license snapshot: [`KyndeBlade_Godot/assets/third_party/natural_earth_10m_admin1/LICENSE.txt`](../KyndeBlade_Godot/assets/third_party/natural_earth_10m_admin1/LICENSE.txt); regenerate: `scripts/world/generate_basemap_wales_natural_earth.py` |
