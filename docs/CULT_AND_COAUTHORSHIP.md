# Cult-ship & coauthorship (index)

Authorial and collaboration plans for **KyndeBlade** live next to the Godot slice (where the bar is actively used).

| Doc | Purpose |
|-----|---------|
| [`KyndeBlade_Godot/docs/CULT_SHIP_BAR.md`](../KyndeBlade_Godot/docs/CULT_SHIP_BAR.md) | Pillars, risks, **action checklist** (Lane A first, one wound, playtests, GIF atom) |
| [`KyndeBlade_Godot/docs/COAUTHORSHIP_RIDER.md`](../KyndeBlade_Godot/docs/COAUTHORSHIP_RIDER.md) | Copy-paste **commission riders** (letterer, composer, illustrator, consultant, guest beat) |
| [`KyndeBlade_Godot/docs/CONTRIBUTORS_POETRY.md`](../KyndeBlade_Godot/docs/CONTRIBUTORS_POETRY.md) | **Community lines** gate + CC0 template + acceptance table |
