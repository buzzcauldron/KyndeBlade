...
**Target File (WRITE OUTPUT HERE):** `.tdad/workflows/combat-core/initialize-combat/initialize-combat.feature`
...
# BDD Generation: Initialize Combat
...
- docs/CI_GODOT_TESTS.md
- docs/CI_UNITY_TESTS.md
- docs/CULT_AND_COAUTHORSHIP.md
- docs/KYNDEBLADE_CAREFUL_CANON.md
- docs/TDAD_RELEASE_PATHS.md
- docs/UNITY_GODOT_MODULE_MAP.md
- docs/UNITY_STORY_AND_SPAWN_DIGEST.md
...
## Your Task
Write the Gherkin specification for **Initialize Combat**.
