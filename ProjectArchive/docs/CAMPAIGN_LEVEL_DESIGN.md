...
**Boss:** **Covetise** (Avarice/Greed) - The first sin, representing economic injustice
- High defense, gold-based attacks
...
**Rewards:**
- Party level 3-5
- Understanding of work and poverty themes
- First taste of the unresolved nature of the quest
...
**Boss:** **Sloth** (Sluggishness) - But not the sin - rather, the exhaustion of endless work
...
**Rewards:**
- Party level 5-7
- Piers joins as ally/party member
- Understanding that work is both necessary and exhausting
...
**Gameplay:**
- Multi-level dungeon crawl
- Dark, oppressive atmosphere
- 18-25 combat encounters
- Resource scarcity (poverty mechanics)
- Environmental hazards representing economic hardship

**Enemies:**
- Demons and corrupted souls
- **Envie** (Envy) - Born from seeing others have what you lack
...
- **Visual Design (16-Bit Sprite):**
  - Large boss sprite (64×96 or 80×112 px)—ethereal, gaunt, skeletal but not undead
  - Wispy form achieved via dithering and limited palette (8-12 colors)
  - Dark palette: browns (#4A3728), grays (#5C5C5C), deep purples (#3D2E4A)
  - Shadow hands: 16×16 sprite layer, 2-4 frame "reach" animation
  - Hollow eyes: 2-3 dark pixels + 1 bright "watchful" pixel
  - Tattered peasant clothing: ragged 2-3 pixel edges, 4-frame flow animation
  - Arena: Barren field tile set—dead grass, cracked earth, 12-16 color palette
  - No volumetric lighting—mood via dark, desaturated palette
  - 4-6 frame idle/drift animation; 6-8 frame attack animations
...
- Aging effects (characters become slower, but wiser)
- 10-15 combat encounters
- Reflective moments
- The quest feels more distant

**Enemies:**
- **Time** (personified) - Not evil, but relentless
- **Regret** - Things left undone
- **Lost Opportunities** - Paths not taken
- The weight of years

**Boss:** **The Passing Years** (Time itself)
- Cannot be defeated
- Represents the inevitability of aging
- The quest feels further away with each year
...
**Enemies:**
- All previous enemies (mixed encounters)
- **The Seven Deadly Sins** (group encounter)
- **Incompleteness** - The quest itself

**Boss:** **The Shadow of Do-Wel** (Incomplete Virtue)
...
- Helping NPCs (side quests)
- 18-28 combat encounters
- Community building
...
**Boss:** **Social Discord** (Community Division)
- Splits party
- Represents how poverty divides
- Requires cooperation, but cooperation is hard when poor
...
**Gameplay:**
- Final community challenges
- 15-22 combat encounters
- Community-wide battle
- Major story progression: Grace is still not found

**Enemies:**
- All community threats combined
- **The Seven Deadly Sins** (group encounter, stronger)
- **The Absence of Grace** - What's missing

**Boss:** **Community Division** (The Split)
- Represents social fracture
- Requires unity to defeat, but unity is hard
- Grace remains distant
...
- Difficult terrain
- 18-28 combat encounters
- Aging affects all mechanics
- Exhaustion is constant
- The quest feels impossible

**Enemies:**
- All previous enemy types (mixed)
- **All Seven Deadly Sins** (individual encounters)
- **Pride** (appearing, growing stronger)
- **The Impossibility of the Quest** - The quest itself

**Boss:** **The Seven Deadly Sins** (Sequential Boss Rush)
- Fight all seven in sequence
- Each more powerful than before
- Tests all party skills
- But Pride is the strongest
...
**Gameplay:**
- Multiple corrupted zones
- 25-35 combat encounters
- Environmental storytelling
- Pride grows from work and poverty
- The quest for Grace seems impossible

**Enemies:**
- World corruption
- Unbalanced forces
- **All Seven Deadly Sins** (group encounter)
- **Pride** (growing stronger)

**Boss:** **The Great Imbalance** (World Corruption)
- Affects entire world
- Multi-zone boss fight
- Pride grows from imbalance
...
- All major enemies return
- **Pride** (appearing, testing the party)
- Pride's influence everywhere

**Boss:** **Pride's Influence** (The Corruption of Pride)
- Multi-phase epic battle
- Pride corrupts Truth and Falsehood
- Makes Grace seem impossible
...
- Final challenges
- 18-25 combat encounters
- Direct confrontation with Pride
- The quest remains unresolved

**Enemies:**
- **Pride** (final form)
- Pride's manifestations
- The impossibility of the quest

**Boss:** **Pride** (The Final Boss)
- The ultimate obstacle to Grace
- Multi-phase fight
- Represents spiritual arrogance, economic pride, the pride of work, the pride of poverty
- Cannot be fully defeated - only faced
...
- The quest remains unresolved
- Beautiful, melancholic ending

**Enemies:** None (story only)

**Boss:** None

**Musical Theme:** "The Unresolved Quest" - The final, most beautiful theme. About the search that never ends, the work that never stops, the poverty that persists, and the Grace that may never be found - but the search itself is beautiful.

**Rewards:**
- Story completion
- Understanding that the quest is the journey, not the destination
- Grace may never be found, but the search is meaningful

---

## Side Content & Optional Areas

### Optional Dungeons (15-20 hours additional)
1. **The Seven Sins' Strongholds** (7 dungeons, 2-3 hours each) - Each sin's domain
2. **The Workhouses** (3 dungeons, 1-2 hours each) - Places of endless labor
3. **The Poor Houses** (4 dungeons, 1-2 hours each) - Places of poverty
4. **The Aging Fields** (5 dungeons, 2-3 hours each) - Places where time passes

### Side Quests (10-15 hours additional)
- Character-specific quests about aging and unfulfilled dreams
- NPC relationship quests about work and poverty
- Collection quests about lost opportunities
- Exploration quests about the unresolved nature of spiritual seeking
- Hidden areas representing moments of near-Grace (but not quite)

### Endgame Content (5-10 hours additional)
- New Game+ with increased difficulty and deeper melancholy
- Super-bosses representing different aspects of Pride
- Challenge modes about the impossibility of the quest
- Time trials about the urgency of aging
- Perfect run challenges that still end unresolved
...
- "Pride's Domain" - Beautifully sad, about the final obstacle
- "The Unresolved Quest" - The final, most beautiful theme. About the search that never ends.

**Music Sources:** See MUSIC_SOURCES.md for copyright-free music sources and licensing information.
...
### Experience & Leveling
- **Combat encounters:** Primary XP source
- **Quest completion:** Bonus XP
- **Work:** XP from labor (but exhausting)
- **Aging:** Affects stats (slower, but wiser)

### Character Progression
- **Levels 1-10:** Youthful hope
- **Levels 11-20:** Learning about work and poverty
- **Levels 21-30:** Middle age, quest intensifies
- **Levels 31-40:** Growing old, quest remains unresolved
- **Levels 41-50:** Final years, facing Pride

### Aging System
- Characters age throughout the campaign
- Stats change (slower speed, but higher wisdom)
- Exhaustion becomes more common
- The quest feels more urgent, but also more impossible

### Poverty System
- Resources are always scarce
- Economic choices affect gameplay
- Poverty makes the quest harder
- But the search continues

---

## The Unresolved Quest

**Key Theme:** Grace is never fully found. The game ends with the quest still unresolved. This is not a failure - it's the nature of spiritual seeking. The quest is not about finding Grace - it's about the search itself.

**The Final Message:**
- Work continues
- Poverty persists
- Pride remains
- Grace may never be found
- But the search is beautiful
- The quest itself is meaningful
- The journey matters, even if the destination is never reached
