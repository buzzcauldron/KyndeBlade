...
This document outlines the visual design philosophy for Kynde Blade.

---

## Primary Artistic References (Strong Guidance)

**Two references should strongly guide all artistic direction:**

| Reference | Use for |
|-----------|--------|
| **The Salome image** | Pre-Raphaelite / Symbolist Salome: **character pose and pathos**, **jewel-like saturation** (crimson, emerald, ultramarine), **heavy fabric** (velvet, silk), **portrait-like focus**, **dramatic stillness** (figures caught in moments of high drama or tragic beauty). Characters should feel like they stepped out of a Salome painting. |
| **Alan Lee art** | Tolkien / Faeries illustrator: **environments**, **light and atmosphere**, **detailed natural texture** (foliage, stone, water), **medieval–fantasy mood**, **character–environment integration**. The world should feel drawn from Lee’s Lord of the Rings, Hobbit, and Faeries work. |

When defining palettes, character design, or environment art, ask: *Would this read as a Salome-like figure in a Lee-like world?*
...
| **Game world** | Original medieval + Pre-Raphaelite (Salome) + Alan Lee | This document — characters, environments, combat |
...
- **Emotional intensity**: Faces and poses convey inner state; melancholy, longing, resolve; **dramatic stillness** as in a Salome painting
...
**Artists to reference**: Dante Gabriel Rossetti, Edward Burne-Jones, William Holman Hunt, John Everett Millais—and **Salome / John the Baptist** imagery (dramatic single figure, jewel tones, tragic beauty) for character and pathos.

**Primary aesthetic references**: **The Salome image** (character, pathos, jewel tones) + **Alan Lee** (environment, atmosphere). [Visual inspiration image](https://p.kagi.com/proxy/images?c=_m3km2RjA3G0qleowsZXHZb9NEn0fSsEYIHbKzMDyAFb4nUPIanknmQV_g0rmdCI0DidjiPdpslW_gCNurNfZBZFAQ-vjQWMQ1YRaCRUvLgu_Dx4mMC7REmhM_x9AHhTsMa7LvNStM1-FDjAiFqUmg%3D%3D) — mood, palette, composition.
...
- **On the edge of gory and sinewy where appropriate**: Push **visceral, sinewy, bodily** detail when it serves the moment—Hunger’s hollow anatomy, the Green Knight’s beheading game, wounds, martyrdom, manuscript violence. Stylized and suggested (Pre-Raphaelite / manuscript) rather than gratuitous; stay on the edge.
...
**Overall Appearance:**
- **Form**: Ethereal, gaunt figure—skeletal but not undead; **sinewy**, on the edge of gory (suggested ribs, stretched skin, hollows) where the sprite allows. Tragic, not gratuitous.
